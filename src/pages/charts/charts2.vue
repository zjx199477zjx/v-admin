  ...
  export default {
    data () {
      return {
        startTime: curDate(-1),
        endTime: curDate(),
        measureType: 'temperature&glucose&pressure&oxygen&height&blood_fat&weight&pulse&urinalysis&body_fat&hemoglobin&blood_uric_acid&height_weight&rate&eyesight',
        optionsA: {
          tooltip: {
            trigger: 'item'
          },
