...
<template>
  <div class="filter">
      <div class="header-btn">
        ...
        :export-config="{}"
        :data="tableData">
        <vxe-table-column field="tj_number" title="档案编号"></vxe-table-column>
        ...
        <vxe-table-column title="健康体检"  cell-type="string">
            <template slot-scope="items">
               <el-button v-if="items.row.recordsid" type="primary" size="small"  @click="healthyCheckUp(items)">查看</el-button>
            </template>
        </vxe-table-column>
  ...
  export default {
    ...
    methods: {
       ...
       getExaminationList(value) {
          ...
          this.axios.post('SihealIMManagement/health_file/exam_list', params).then(res => {
