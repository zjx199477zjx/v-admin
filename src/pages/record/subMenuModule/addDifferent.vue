            ...
            <div class="page-addDifferent">
                <vxe-table
                    ...
                    <vxe-table-column title="操作"  cell-type="string">
                        ...
                        <el-button  type="primary" size="small"  @click="healthyCheckUp(items)">新建</el-button>
                        </template>
                    </vxe-table-column> 
                </vxe-table>
            </div>
  ...
  export default {
    ...
    //   },
      getDifferentList(value) {
        ...
        this.axios.post('SihealIMManagement/health_file/add_medical_somatoplasm_list', params).then(res => {
          res = res || {};
