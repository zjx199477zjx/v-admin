  ...
  <div class="filter">
    ...
    <div class="dialog">
        <el-dialog title="健康体检" :visible.sync="dialogFormVisible" :modal-append-to-body="false"  width="60%">
            ...
            <fromViewHealthInfo ref="createFrom4" :record="curRecordId" componentName='get_diabetes_exam' postUrl="SihealIMManagement/health_file/get_diabetes_exam"></fromViewHealthInfo>
  ...
  export default {
    ...
    methods: {
       ...
       getExaminationList(value) {
          ...
          this.axios.post('SihealIMManagement/health_file/diabetes_examination_list', params).then(res => {
