        ...
        <div class="header-btn">
            ...
            <div class="page-addDifferent">
                <vxe-table
                    ...
                    <vxe-table-column field="tj_date" title="建档日期" :formatter="dateFormat"></vxe-table-column>
                    ...
                    <vxe-table-column title="老年人健康体检"  cell-type="string">
                        <template slot-scope="items">
                        <el-button  type="primary" size="small"  @click="addPeopleExamination(items)">查看</el-button>
                        </template>
                    </vxe-table-column> 
                </vxe-table>
            </div>
  ...
  export default {
    ...
    methods: {
      getDifferentList(value) {
        ...
        this.axios.post('SihealIMManagement/health_file/elderly_examination_list', params).then(res => {
          res = res || {};
